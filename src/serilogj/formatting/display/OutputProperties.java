...
public class OutputProperties {
	...
	*/
	public static Map<String, LogEventPropertyValue> GetOutputProperties(LogEvent logEvent)
	{
		...
		result.put(MessagePropertyName, new LogEventPropertyMessageValue(logEvent.getMessageTemplate(), logEvent.getProperties()));
		...
		String exception = logEvent.getException() == null ? "" : (logEvent.getException() + System.lineSeparator());
