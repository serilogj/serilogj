...
public class LogEventLevelValue extends LogEventPropertyValue  {
	...
	private static final String[][] shortenedLevelMap =
	{
		new String[]{"V", "Vb", "Vrb", "Verb"},
		new String[]{"D", "De", "Dbg", "Dbug"},
		new String[]{"I", "In", "Inf", "Info"},
		new String[]{"W", "Wn", "Wrn", "Warn"},
		new String[]{"E", "Er", "Err", "Eror"},
