...
public class ColoredConsoleSink implements ILogEventSink {
	...
	private void renderExceptionToken(MessageTemplateToken outputToken, Palette palette, Map<String, LogEventPropertyValue> properties) {
		setHighlightColors(palette);
		renderToken(outputToken, properties);
	}
	
	private void renderOutputToken(MessageTemplateToken outputToken, Palette palette, Map<String, LogEventPropertyValue> properties) {
		setBaseColors(palette);
		renderToken(outputToken, properties);
	}
