...
public class LoggerConfiguration {
	...
	*/
	public Logger createLogger() {
		...
		PropertyValueConverter converter = new PropertyValueConverter(maximumDestructuringDepth, additionalScalarTypes.toArray(new Class<?>[0]), additionalDestructuringPolicies.toArray(new IDestructuringPolicy[0]));
