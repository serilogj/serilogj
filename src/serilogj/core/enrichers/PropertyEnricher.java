...
public class PropertyEnricher implements ILogEventEnricher {
	...
	/** 
	 ...
	 @param destructureObjects If true, and the value is a non-primitive, non-array type,
	...
	*/
	...
	/** 
	 ...
	 @param propertyFactory Factory for creating new properties to add to the event.
	*/
